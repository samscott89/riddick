/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c4be30b437c555e80e23c7cd8663e59c)
// Runtime types generated with workerd@1.20250709.0 2024-10-22 service_binding_extra_handlers
...
type Fetcher<T extends Rpc.EntrypointBranded | undefined = undefined, Reserved extends string = never> = (T extends Rpc.EntrypointBranded ? Rpc.Provider<T, Reserved | "fetch" | "connect" | "queue" | "scheduled"> : unknown) & {
